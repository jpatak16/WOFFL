...
```{r}
library(pacman)
p_load(dplyr, stargazer, data.table, formattable, tidyr, ggplot2, readxl, gganimate, janitor, magrittr, kableExtra, gridExtra, ggalt, forcats, gt, gtExtras)
```

```{r}
#import data set
AllGames = read.csv("~/Fantasy/WOFFL/WOFFL_stats_portal/AllGames.csv") %>%
  clean_names() %>%
