...
```{r}
library(pacman)
p_load(dplyr, stargazer, data.table, formattable, tidyr, ggplot2, readxl, gganimate, janitor, magrittr, kableExtra, gridExtra)
```
...
```{r}
a = AllGames %>% group_by(season, week) %>% summarise(PF = sum(score))
